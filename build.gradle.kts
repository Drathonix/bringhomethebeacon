...
class ModDependencies {
    ...
    val isCCTPresent = false
    val isMekanismPresent = false
}
...
dependencies {
    ...
    //mappings("net.fabricmc:yarn:${env.mc_ver}+build.${property("yarn_build")}:v2")
    ...
    if(env.isFabric) {
        ...
        //modImplementation("com.vicious:persist:${deps["mod.persist"]}")
    }
    if(env.isForge){
        "forge"("net.minecraftforge:forge:${deps["forge_ver"]}")
        //"forgeRuntimeLibrary"("com.vicious:persist:${deps["mod.persist"]}")
